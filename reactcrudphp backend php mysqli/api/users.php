...
switch($method)
{
   case "GET": 
    ...
    if(isset($path[4]) && is_numeric($path[4]))
    {
      $json_array= array();
      $userid= $path[4];
      $getuserrow= mysqli_query($db_conn, "SELECT * FROM tbl_statistique WHERE userid='$userid' ");
    ...
    $alluser= mysqli_query($db_conn, "SELECT * FROM tbl_statistique"); 
    ...
    case "POST":
        ...
        $result= mysqli_query($db_conn, "INSERT INTO tbl_statistique (username, useremail) 
    ...
    case "PUT":
          $userUpdate= json_decode(file_get_contents("php://input"));
           ...
           $updateData= mysqli_query($db_conn, "UPDATE tbl_statistique SET username='$username', useremail='$useremail' WHERE userid='$userid'  ");
           if($updateData)
           {
         ...
         // print_r($userUpdate); die;
          ...
          case "DELETE":
            ...
            $result= mysqli_query($db_conn, "DELETE FROM tbl_statistique WHERE userid= '$path[4]' ");
            if($result)
            {
